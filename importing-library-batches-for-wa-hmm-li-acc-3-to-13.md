# Importing Library batches for WA/HMM/LI/Acc/3 to /13
...
* Add the RID#s to each cell in the RID# column in the transcription spreadsheet, by copying the formula `=IFERROR(VLOOKUP(C2,Sheet2!A:B,2,FALSE),"")` into cell A2 and filling down the column.
